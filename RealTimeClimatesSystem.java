...
public class RealTimeClimatesSystem {
    ...
    public static String getDadosClimaticos(String cidade) throws Exception {
        ...
        // Cria objeto enviar solicitações HTTP e receber respostas HTTP, para acessar o
        // site da WeatherAPI
        HttpClient cliente = HttpClient.newHttpClient();

        // Envia requisições HTTP e recebe respostas HTTP - comunicação com o site da
        // API
    ...
    public static void imprimirDadosClimaticos(String dados) {
        // System.out.println("Dados originais (JSON) obtidos no site meteorológico" +
        // dados)
